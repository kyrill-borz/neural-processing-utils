...
# Downloaded by Amparo Guemes on October 2021  
...
#sys.path.append('C:/Users/amparo.guemesg/Documents/pyneural/pyNeural/datasets/load_intan_rhs_format/')
#sys.path.append('C:/Users/User/OneDrive - University of Cambridge/pyNeural/datasets/load_intan_rhs_format/')
...
def read_rhs_data(filename, verbose=1):
    ...
    with open(filename, 'rb') as fid:
        ...
        if data_present:
            ...
            data = {}
            data['t'] = np.zeros(num_amplifier_samples, dtype=np.int32)
            ...
            data['stim_data_raw'] = np.zeros([header['num_amplifier_channels'], num_amplifier_samples], dtype=np.int32)
            data['stim_data'] = np.zeros([header['num_amplifier_channels'], num_amplifier_samples], dtype=np.int32)
...
if __name__ == '__main__':
    path = 'C:/Users/amparo.guemesg/Documents/pyneural/pyNeural/datasets/cambridge/recording/05_2021_SC_recordings/'
    filename = 'Recording_SC_alternating2_210401_123542.rhs'
    a = read_data(path+filename)
    print(a)
